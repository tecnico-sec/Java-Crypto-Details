...
public class ImageMixer {
     ...
     *                             method, to be applied to the images
     * @throws Exception
     */
    public static void mix(String image1FilePath, String image2FilePath, String outputImageFilePath,
     ...
     * @throws IOException
     */
    public static void mix(String imageFilePath, String outputImageFilePath, ByteArrayMixer manipulationFunction)
            throws Exception {
     ...
     * This is only ready to deal with images with a colormap of 1 bit. Proceed at
     * your own risk.
     * 
    ...
    private static BufferedImage getImageFromArray(byte[] pixels, int width, int height) {
        // create a binary color model, with a b/w colormap, where white (index 0) is
